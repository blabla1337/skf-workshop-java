...
public class AuditLog {
	...
	public String counter(int counting, int userID)
    {
		...
		DataSource ds = (DataSource)webContext.lookup("jdbc/auditlogs_Jdbc");
        ...
        {        	
    		...
    		DataSource ds3 = (DataSource)webContext3.lookup("jdbc/auditlogs_Jdbc");
    		conn3 = ds3.getConnection();	
             
    	      // create the java mysql update preparedstatement
    	      String query3 = "UPDATE counter set access = ? WHERE userID = ?";
    	      PreparedStatement preparedStmt3 = conn3.prepareStatement(query3);
    	      preparedStmt3.setInt(1, access);
    	      preparedStmt3.setInt(2, userID);
		...
		DataSource ds2 = (DataSource)webContext2.lookup("jdbc/auditlogs_Jdbc");
